...
int main() {
    ...
    for (i = 0; i <= n - 1; i++) {
        ...
        cin >> nomi[i];
        cout << "Di che nazionalità è 'atleta numero" << i + 1 << endl;
        cin >> nazionali[i];
    ...
    cout << "Il tempo è più basso è " << min << endl;
    double max;
    int x;
    ...
    cout << "Il tempo più alto è " << max << endl;
    double somma, media;
    int s;
    ...
    media = somma / n;
    cout << "La media dei tempi è " << media << endl;
    min = media;
    int c;
